<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ url('/') }}">
                        <img
                        src="{{ asset('images/homeblog.png') }}" alt="My Logo" class="block h-10 w-10 10 rounded-full">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="url('/dashboard')" :active="request()->is('/')">
                        {{ __('Dashboard') }}
                    </x-nav-link>
    ...
    @endif
                                <x-nav-link :href="url('/Blogpost')" :active="request()->is('/')">
                        {{ __('Post') }}
                    </x-nav-link>            
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="url('/dashboard')" :active="request()->is('/')">
                {{ __('Dashboard') }}
